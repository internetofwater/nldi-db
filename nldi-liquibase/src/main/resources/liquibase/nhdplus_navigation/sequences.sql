...
alter sequence nhdplus_navigation.tmp_navigation_status_seq owner to nhdplus;
...
alter sequence nhdplus_navigation.tmp_navigation_results_seq owner to nhdplus;
