...
alter sequence nhdplus_navigation.tmp_navigation_status_seq owner to ${NHDPLUS_SCHEMA_OWNER_USERNAME};
...
alter sequence nhdplus_navigation.tmp_navigation_results_seq owner to ${NHDPLUS_SCHEMA_OWNER_USERNAME};
